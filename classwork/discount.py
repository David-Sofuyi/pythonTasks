...
user_input =int(input ("what is the total amount you spent: "))
if(user_input >= 1000 and user_input <= 10000):
    print("5% discount applicable pay")
    discount_applied = (user_input * 0.05)
    amount_due = (user_input - discount_applied)
    print (amount_due)
    
elif(user_input >= 10000 and user_input <= 50000):
    print("10% discount applicable pay")
    discount_applied = (user_input * 0.10)
    amount_due = (user_input - discount_applied)
    print (amount_due)
